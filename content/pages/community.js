export const COMMUNITY_CHANNELS = [
  {
    name: "Server Discord",
    description:
      "Il server pubblico è operativo. Gli inviti vengono gestiti via email per personalizzare l’onboarding in base agli interessi dichiarati.",
    action: "Richiedi invito",
    href: "mailto:community@attuario.eu?subject=Richiesta%20invito%20Discord",
  },
  {
...
export const COMMUNITY_INITIATIVES = [
  {

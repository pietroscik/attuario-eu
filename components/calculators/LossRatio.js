  ...
  return (
    <section id="loss-ratio" className="card calculator-card">
      ...
      <div className="calculator-metrics">
        Loss ratio ≈ <b>{lossRatio.toFixed(1)}%</b>
        Combined ratio ≈ <b>{combinedRatio.toFixed(1)}%</b>
        Margine tecnico ≈ <b>{margine.toFixed(1)}%</b>
        Risultato tecnico ≈ <b>€ {risultatoTecnico.toFixed(2)}</b>
      </div>

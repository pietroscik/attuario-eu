  ...
  return (
    <section id="premio-puro" className="card calculator-card">
      ...
      <div className="calculator-metrics">
        Frequenza = <b>{(frequenza * 100).toFixed(2)}%</b>
        Severità attesa ≈ <b>€ {severita.toFixed(2)}</b>
        Sinistri attesi ≈ <b>{sinistriAttesi.toFixed(1)}</b>
        Premio puro ≈ <b>€ {premio.toFixed(2)}</b>
      </div>
